...
st.title('Heart Disease Prection : BIS698 Workshop 64130700318')
...
with tab1:
    ...
    #'Oldpeak'
    x10 = st.slider('Oldpeak', -2.6, 6.2, 0.0)
    ...
    if pred ==0 : 
        st.subheader(':green[Normal]')
    else :
        st.subheader(':red[Heart Disease]')
